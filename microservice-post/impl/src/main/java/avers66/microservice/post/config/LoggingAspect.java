package avers66.microservice.post.config;
...
public class LoggingAspect {
    ...
    @Pointcut("within(avers66.microservice.post..*)" +
            " || within(avers66.microservice.post.service..*)" +
            " || within(avers66.microservice.post.resource..*)")
